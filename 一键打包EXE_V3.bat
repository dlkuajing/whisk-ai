@echo off
chcp 65001 >nul
title 🚀 跨海帆-Imager V3 - 一键打包EXE工具

cls
echo.
echo ╔══════════════════════════════════════════════════════════════╗
echo ║              🚀 跨海帆-Imager V3 一键打包工具               ║
echo ╚══════════════════════════════════════════════════════════════╝
echo.
echo 📋 功能说明：
echo    • 自动检查并安装所有依赖
...
REM 检查打包结果
if exist "跨海帆-Imager_V3_Distribution\跨海帆-Imager_V3.exe" (
    goto :success
) else (
    goto :failed
)
...
echo ╚══════════════════════════════════════════════════════════════╝
echo.
echo 📁 输出位置：跨海帆-Imager_V3_Distribution\
echo.
echo 📋 包含文件：
echo    🎯 跨海帆-Imager_V3.exe    主程序文件
echo    📖 README.md               使用说明
echo    🚀 启动跨海帆.bat           启动脚本
echo    ⚙️  config_gui_v2.json      配置文件
echo.
echo 💡 使用方法：
echo    1. 将整个 跨海帆-Imager_V3_Distribution 文件夹复制到目标电脑
echo    2. 双击 跨海帆-Imager_V3.exe 或 启动跨海帆.bat 运行程序
